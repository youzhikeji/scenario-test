    ...
    function renderStatsAll(steps, iterations, scenario, scenarioFile) {
      ...
      if (scenarioTotal > 0 && scenarioTotal <= 24) {
        for (var idx = 0; idx < scenarioTotal; idx++) {
          ...
          var segClass = isPassed ? "bg-emerald-500 shadow-2xs" : isFailed ? "bg-rose-500 shadow-2xs" : isSkipped ? "bg-slate-300" : "bg-slate-200/80 border border-slate-300/60";
