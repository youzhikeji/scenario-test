...
#   ./install.sh /path/to/project scenario-test "https://gitlab.example.com/group/project/-/raw/v0.5.14/dist"
#   curl -fsSL https://cdn.jsdelivr.net/gh/youzhikeji/scenario-test@v0.5.14/scripts/install.sh | bash -s -- /path/to/project scenario-test
#
...
SCENARIO_TEST_VERSION="${SCENARIO_TEST_VERSION:-0.5.14}"
